...
function loadDashboardTables(request, response){
   
  const {level,category}=request.params
  response.render("adminDashboardTables", {
    user: request.user,
...
/*new project exports under this line*/
  loadDashboard,
  loadDashboardTables
